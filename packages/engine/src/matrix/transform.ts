import { fillMatrix, RectInMatrix } from './createMatrix';

/**
 * 完全的移动
 */
export function transformBlock(matrix: Int8Array[], from: RectInMatrix, to: RectInMatrix) {
  // 清零
 ...
 * 其它参数不变，只改变元素top属性
 */
export function transformBlockTop(matrix: Int8Array[], from: RectInMatrix, to: RectInMatrix) {
